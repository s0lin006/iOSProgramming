...
//        NotificationCenter.default.addObserver(self, selector: #selector(handleKeyboardWillHide), name: NSNotification.Name.UIKeyboardDidHide, object: nil)
    ...
    func setupInputComponents()
    {
        ...
        inputContainerView.inputTextField.rightAnchor.constraint(equalTo: sendButton.leftAnchor).isActive = true
    ...
    func handleSendLongPress()
    {
        let properties: [String: Any] = ["text": inputContainerView.inputTextField.text!, "expire" : true]
        sendMessageWithProperties(properties: properties as [String : AnyObject])
